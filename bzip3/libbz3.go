 ...
 */
//go:linkname Bz3Version C.bz3_version
func Bz3Version() *int8

/**
 * @brief Get the last error number associated with a given state.
 */
// llgo:link (*Bz3State).Bz3LastError C.bz3_last_error
func (recv_ *Bz3State) Bz3LastError() int8 {
	return 0
}
 ...
 */
// llgo:link (*Bz3State).Bz3Strerror C.bz3_strerror
func (recv_ *Bz3State) Bz3Strerror() *int8 {
	return nil
}
 ...
 */
//go:linkname Bz3New C.bz3_new
func Bz3New(block_size int32) *Bz3State

/**
 * @brief Free the memory occupied by a block encoder state.
 */
// llgo:link (*Bz3State).Bz3Free C.bz3_free
func (recv_ *Bz3State) Bz3Free() {
}

/**
 * @brief Return the recommended size of the output buffer for the compression functions.
 */
//go:linkname Bz3Bound C.bz3_bound
func Bz3Bound(input_size uintptr) uintptr
 ...
 */
//go:linkname Bz3Compress C.bz3_compress
func Bz3Compress(block_size uint32, in *uint8, out *uint8, in_size uintptr, out_size *uintptr) c.Int
 ...
 * Make sure to set out_size to the size of the output buffer before the operation.
 */
//go:linkname Bz3Decompress C.bz3_decompress
func Bz3Decompress(in *uint8, out *uint8, in_size uintptr, out_size *uintptr) c.Int
 ...
 */
//go:linkname Bz3MinMemoryNeeded C.bz3_min_memory_needed
func Bz3MinMemoryNeeded(block_size int32) uintptr
 ...
 */
// llgo:link (*Bz3State).Bz3EncodeBlock C.bz3_encode_block
func (recv_ *Bz3State) Bz3EncodeBlock(buffer *uint8, size int32) int32 {
	return 0
}
 ...
 */
// llgo:link (*Bz3State).Bz3DecodeBlock C.bz3_decode_block
func (recv_ *Bz3State) Bz3DecodeBlock(buffer *uint8, buffer_size uintptr, compressed_size int32, orig_size int32) int32 {
	return 0
}
 ...
 *      in turn
 */
//go:linkname Bz3OrigSizeSufficientForDecode C.bz3_orig_size_sufficient_for_decode
func Bz3OrigSizeSufficientForDecode(block *uint8, block_size uintptr, orig_size int32) c.Int
