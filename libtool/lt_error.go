...
//go:linkname LtDladderror C.lt_dladderror
func LtDladderror(diagnostic *int8) c.Int

//go:linkname LtDlseterror C.lt_dlseterror
func LtDlseterror(errorcode c.Int) c.Int
