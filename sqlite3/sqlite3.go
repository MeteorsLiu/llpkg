...
const VERSION_NUMBER = 3036000
const SOURCE_ID = "2021-06-18 18:36:39 5c9a6c06871cb9fe42814af9c039eb6da5427a6ec28f187af7ebfb62eafa66e5"
const OK = 0
const ERROR = 1
const INTERNAL = 2
const PERM = 3
...
func UriBoolean(zFile *int8, zParam *int8, bDefault c.Int) c.Int

//go:linkname UriInt64 C.sqlite3_uri_int64
func UriInt64(*int8, *int8, Int64) Int64

//go:linkname UriKey C.sqlite3_uri_key
func UriKey(zFilename *int8, N c.Int) *int8
...
func CreateFilename(zDatabase *int8, zJournal *int8, zWal *int8, nParam c.Int, azParam **int8) *int8

//go:linkname FreeFilename C.sqlite3_free_filename
func FreeFilename(*int8)
...
func (recv_ *Sqlite3) DbFilename(zDbName *int8) *int8 {
	return nil
}
